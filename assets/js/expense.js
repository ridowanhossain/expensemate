$(document).ready(function () {
  ...
  // Open Edit Modal
  $("#expensetablesSimple").on("click", ".edit-btn", function () {
  ...
  $(document).on("click", ".edit-btn", function () {
    ...
    $.ajax({
      url: "actions/fetch_add_expense_category.php",
      type: "GET",
      dataType: "json",
      success: function (response) {
        if (response.status === "success") {
  ...
  // Delete Entry
  $("#expensetablesSimple").on("click", ".delete-btn", function () {
    const id = $(this).data("id");
    const type = $(this).data("type");
  ...
  // Function for Expense Table
  const table = $("#expensetablesSimple").DataTable({
    ajax: {
      url: "actions/fetch_expense.php",
      type: "POST",
      data: {
        action: "fetch_ledger",
      },
