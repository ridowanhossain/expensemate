...
<div class="container-fluid px-4">
    <div class="row">
        ...
        <div class="col-md-8 d-flex justify-content-end align-items-center">
            ...
            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#addExpenseModal">Expense</button>
        </div>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-header">
            ...
            <?php echo date("F"); ?> Expense Statement
        </div>
        <div class="card-body">
            <div class="mb-3">
            ...
            <table class="table table-bordered table-striped table-hover" id="expensetablesSimple">
                <thead>
                    <tr>
